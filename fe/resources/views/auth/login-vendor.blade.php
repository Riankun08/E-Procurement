...
<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
    <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="{{ route('authentications.store') }}" method="POST">
        ...
        <div class="text-center">
            ...
            <br>    
            <br>    
            <span class="form-label fw-bolder text-dark fs-6 mb-0">Dont have account ? <a href="{{ route('authentications.register.vendor') }}"><span style="color: #f08e48">register here!</span></a></span>
        </div>
    </form>
</div>
@endsection
