    ...
    <div id="kt_content_container" class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-8">
                ...
                <div class="card">
                    @include('form.form-question.index')
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-10 mb-lg-0">
                            ...
                            <div class="m-0">
                                <!--begin::Title-->
                                <h4 class="fs-1 text-gray-800 w-bolder mb-6">Information Form Group</h4>
                                <!--end::Title-->
                            </div>
                            <!--end::Description-->
                            <!--begin::Accordion-->
                            ...
                            <div class="m-0">
                                <!--begin::Heading-->
                                <div class="d-flex align-items-center collapsible py-3 toggle mb-0 collapsed" data-bs-toggle="collapse" data-bs-target="#kt_job_2_1">
                                    <!--begin::Icon-->
