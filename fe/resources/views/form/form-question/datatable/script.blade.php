<script>
    ...
    var KTUsersList = function() {
        ...
        var table = $('#kt_table_form_question');
        var datatable;
        var toolbarBase;
        var toolbarSelected;
        var selectedCount;
        ...
        // CUSTOME TYPE
        var form_id = "{{ isset($data) ? $data->id : '' }}";
        ...
        var initUserTable = function() {
            ...
            datatable = table.DataTable({
                ...
                "deferRender": true,
                "ajax": {
                    "url": `/forms-dynamies/groups/${form_id}`,
                    "type": "GET",
                        ...
                        render: function(data, type, row) {
                            return `
                                <div class="d-flex justify-content-between">
                                    <a href="/forms-dynamies/group/detail/${row.id}" class="btn btn-sm btn-primary p-3 m-1">
                                    ...
                                    <a href="/forms-dynamies/group/edit/${row.id}" class="btn btn-sm btn-success p-3 m-1">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            var handleDeleteRows = function() {
                table.on('click', '.btn-delete', function() {
                    ...
                    Swal.fire({
                        text: "Are you sure you want to delete this Form Group?",
                        icon: "warning",
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                url: `/forms-dynamies/group/delete/${dataId}`,
                                type: 'DELETE',
                                headers: {
                                ...
                                error: function(xhr) {
                                    Swal.fire({
                                        text: "Failed to delete the Form Group.",
                                        icon: "error",
                                        buttonsStyling: false,
                                        confirmButtonText: "Ok, got it!",
                                        customClass: {
