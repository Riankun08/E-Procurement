                        ...
                        render: function(data, type, row) {
                            return `
                                <div class="d-flex justify-content-between">
                                    <a href="/formulas/detail/${row.id}" class="btn btn-sm btn-primary p-3 m-1">
                                    ...
                                    <a href="/formulas/edit/${row.id}" class="btn btn-sm btn-success p-3 m-1">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <button class="p-3 m-1 btn btn-sm btn-danger btn-delete" data-id="${row.id}">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
