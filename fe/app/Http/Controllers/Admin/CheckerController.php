...
// Datatable
use App\DataTables\CheckerDataTable;

class CheckerController extends Controller
{
    public $view = 'checker.';
    public $route = 'checkers.';
    public $title = 'Checker Account';
    public $subtitle = 'List Data Checker Account';
    public $model;
     ...
     */
    public function index(CheckerDataTable $dataTable)
    {
